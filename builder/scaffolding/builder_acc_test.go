...
// Run with: PACKER_ACC=1 go test -count 1 -v ./builder/synopkg/builder_acc_test.go  -timeout=120m
func TestAccScaffoldingBuilder(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "synopkg_builder_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
		...
		Check: func(buildCommand *exec.Cmd, logfile string) error {
			...
			buildGeneratedDataLog := "synopkg-my-builder.basic-example: build generated data: mock-build-data"
