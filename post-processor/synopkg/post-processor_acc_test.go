...
// Run with: PACKER_ACC=1 go test -count 1 -v ./post-processor/synopkg/post-processor_acc_test.go  -timeout=120m
func TestAccScaffoldingPostProcessor(t *testing.T) {
	testCase := &acctest.PluginTestCase{
		Name: "synopkg_post-processor_basic_test",
		Setup: func() error {
			return nil
		},
		Teardown: func() error {
		...
		Type:     "synopkg-my-post-processor",
